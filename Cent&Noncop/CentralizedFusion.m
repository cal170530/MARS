...
iter=iter0;
while (t<=Tf)
% 2.Jingyi comments:notify the w in CentralizedFussion case is without subscript k, meaning that
...
MSD = MSD/numAgents;
MSD
% 4. Jingyi comments: MSD_cent is approcimate to u*M*sigma^2/2/numAgents
% Notice that MSD_ncop is around N times as MSD_cent
